...
public class Machinegun implements Spawnable, Weapon{
	...
	public Machinegun(){
		Spawner.spawn(this);
		this.damage = WeaponConfig.MACHINEGUN_INIT_DAMAGE;
		this.ammo = WeaponConfig.MACHINEGUN_INIT_AMMO;
		this.name = "Machinegun";
		this.rateOfFire = WeaponConfig.MACHINEGUN_INIT_RATE_OF_FIRE;
	}
} 
