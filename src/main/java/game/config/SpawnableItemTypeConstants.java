...
public class SpawnableItemTypeConstants {
    ...
    public static final int DOUBLE_GATLING_GUN = 13;
    ...
    // Shields
    public static final int ATOM_SHIELD = 11;
    public static final int PLASMA_SHIELD = 12;

    // Other
    public static final int HEALTH_PACK = 2;
    public static final int INCREASE_SCORE_1 = 7;
    public static final int INCREASE_SCORE_2 = 8;
    public static final int INCREASE_SCORE_3 = 9;
    public static final int INCREASE_SCORE_4 = 10;
}