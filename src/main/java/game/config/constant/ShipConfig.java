...
public class ShipConfig {
    ...
    public final static SpawnableItemType QUICKSILVER_INIT_WEAPON = SpawnableItemType.SHOTGUN;
    ...
    public final static SpawnableItemType MERCURY_INIT_WEAPON = SpawnableItemType.GATLING_GUN;
    ...
    public final static SpawnableItemType INTERCEPTOR_INIT_WEAPON = SpawnableItemType.LASER_CANNON;
    ...
    public final static SpawnableItemType DELTAWING_INIT_WEAPON = SpawnableItemType.DOUBLE_GATLING_GUN;
    ...
    public final static SpawnableItemType CARGO_SHIP_INIT_WEAPON = SpawnableItemType.GATLING_GUN;
