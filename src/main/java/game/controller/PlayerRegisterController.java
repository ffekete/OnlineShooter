...
public class PlayerRegisterController implements ControllerBase {
    ...
    public RegistrationAnswer registerNewPlayer(RegistrationData data) {
        ...
        if (data.getName() != null) {
            ...
            System.out.println("New player registration request received with name " + data.getName() + " and ship "
                    + data.getShipType() + ".");
            ...
            if (playerPool.registerPlayer(newId, data)) {
                ...
                System.out.println("Player registered with id " + newId + " and name " + data.getName()
                        + ". Connection id is " + playerData.getConnectionId());
